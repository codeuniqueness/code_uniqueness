...
public class W342DEF{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nWelcome to the constant weight binary code bounds java program for computing B_4(n,d,w) ");
...
try{ SDPwriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("CW34DEF_"+n+"_"+d+"_"+w+ ".sdp"), "utf-8"));
...
//
// We doen het geval C= empty, tweetallen (in the article C is called "D")
//
...
//String var10="x41";
 ...
 BigInteger coefficientleeg=  new BigInteger("1"); //binomial(n,e12);//
...
//NEXT, ADD BLOCKS FOR |D|=2, QUADRUPLES
...
//
//-------------------------------------------------------------------------------
// Subroutine verwerk. Hier wordt een monoom (in x-variabelen) verwerkt: aan een monoom wordt het nummer van zijn S4-ortbit toegekend.
//
//
*/
